    ...
    def add_user(self, workspace_id: str, slack_id: str, name: str) -> bool:
        try:
            ...
            with conn.cursor() as cursor:
                ...
                cursor.execute("SELECT slack_id FROM Users WHERE slack_id = %s", (slack_id,))
                ...
                # cursor.execute(t)
                cursor.execute("INSERT INTO Users (slack_id, name) VALUES (%s, %s)", (slack_id, name))
    ...
    def delete_user(self, workspace_id: str, slack_id: str) -> bool:
        try:
            ...
            with conn.cursor() as cursor:
                ...
                # cursor.execute(t)
                cursor.execute("""
                    SELECT slack_id FROM users WHERE slack_id = %s
                """, (slack_id, ))
    ...
    def add_channel(self, workspace_id: str, channel_id: str,
        ...
        try:
            ...
            with conn.cursor() as cursor:
                ...
                # cursor.execute(t)
                cursor.execute("INSERT INTO channels (id, name) VALUES (%s, %s)", (channel_id, name))
    ...
    def add_message(self, workspace_id: str, channel_id: str, channel_name: str, msg_id: str,
        ...
        try:
            ...
            with conn.cursor() as cursor:
                ...
                # cursor.execute(t)
                cursor.execute("SELECT message_id FROM kudos WHERE message_id = %s", (msg_id, ))
                if cursor.fetchall() == []:
                    if kudos_value is not None:
                        for value in kudos_value:
                            # t = f"SELECT id FROM {workspace_id}.corp_values WHERE corp_value = '{value}'"
                            # cursor.execute(t)
                            cursor.execute("SELECT id FROM corp_values WHERE corp_value = %s", (value, ))
                            ...
                            # cursor.execute(t)
                            cursor.execute("INSERT INTO kudos (message_id, corp_value_id) VALUES (%s, %s)", (msg_id, kudos_value_id))
            ...
            with conn.cursor() as cursor:
                ...
                for value in values:
                    ...
                    if value not in curr_values:
                        ...
                        # cursor.execute(t)
                        cursor.execute("INSERT INTO corp_values (corp_value) VALUES (%s)", (value, ))
    ...
    def get_corp_values(self, workspace_id: str) -> List[str]:
        try:
            ...
            with conn.cursor() as cursor:
                ...
                # cursor.execute(t)
                cursor.execute('select corp_value from corp_values')
    ...
    def get_user_kudos(self, workspace_id: str, user_id: str,
        ...
        try:
            ...
            with conn.cursor() as cursor:
                ...
                WHERE messages.to_slack_id = %s AND
                time <= to_timestamp(%s) AND time >= to_timestamp(%s)
                GROUP BY kudos.corp_value_id, corp_values.corp_value;
